...
window.addEventListener('load', function() {
  ...
  nr.notes.push(new Note(1, 2, 3));
  nr.notes.push(new Note(44, 1, 3));
  nr.notes.push(new Note(44, 6, 3));
  nr.notes.push(new Note(8, 5, 3));

  nr.assignNoteGraphics();
  nr.assignAnimationProperties();

console.log(nr.notes);
  var tl = generateTimeline(nr.notes, nr.keys, nr.p);
  tl.play();
